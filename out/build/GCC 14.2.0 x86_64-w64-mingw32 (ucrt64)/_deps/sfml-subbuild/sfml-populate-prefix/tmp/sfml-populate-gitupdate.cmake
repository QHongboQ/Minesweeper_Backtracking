...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/NoSystemFile/Hongbo/VSProject/Minesweeper_Backtracking/out/build/GCC 14.2.0 x86_64-w64-mingw32 (ucrt64)/_deps/sfml-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/NoSystemFile/Hongbo/VSProject/Minesweeper_Backtracking/out/build/GCC 14.2.0 x86_64-w64-mingw32 (ucrt64)/_deps/sfml-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
